...
function handle(i18next) {
  ...
  return function () {
    var _i18nextMiddleware = _asyncToGenerator(regeneratorRuntime.mark(function _callee(rq, rs, n) {
      var _checkForCombinedReqR, req, res, next, ignores, i, i18n, lng, t, exists;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _checkForCombinedReqR = checkForCombinedReqRes(rq, rs, n), req = _checkForCombinedReqR.req, res = _checkForCombinedReqR.res, next = _checkForCombinedReqR.next;
            ...
            case 8:
              ...
              if (!(options.getPath(req).indexOf(ignores[i]) > -1)) {
                _context.next = 11;
                break;
              }
            ...
            case 14:
              ...
              _context.next = 20;
              return i18next.services.languageDetector.detect(req, res);
    ...
    function i18nextMiddleware(_x, _x2, _x3) {
      return _i18nextMiddleware.apply(this, arguments);
    }
